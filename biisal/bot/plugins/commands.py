...
SRT_TXT = """<b>Hᴇʟʟᴏ {}
I ᴀᴍ Tᴇʟᴇɢʀᴀᴍ Fɪʟᴇ ᴛᴏ Lɪɴᴋ Gᴇɴᴇʀᴀᴛᴏʀ Bᴏᴛ ᴡɪᴛʜ Cʜᴀɴɴᴇʟ sᴜᴘᴘᴏʀᴛ. Sᴇɴᴅ ᴍᴇ ᴀɴʏ ғɪʟᴇ ᴀɴᴅ ɢᴇᴛ ᴀ ᴅɪʀᴇᴄᴛ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ ᴀɴᴅ sᴛʀᴇᴀᴍᴀʙʟᴇ Lɪɴᴋ♥️
</b>"""
...
async def start(b, m):
    ...
    await StreamBot.send_photo(
    chat_id=m.chat.id,
    photo="https://telegra.ph/file/672e1397dd7550a357708.jpg",
