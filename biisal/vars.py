...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1001849024462'))
    NEW_USER_LOG = int(getenv('NEW_USER_LOG', '-1001849024462'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'BIND_ADRESS:PORT')) if not ON_HEROKU or getenv('FQDN', 'married-milissent-filmfree-333e214f.koyeb.app') else APP_NAME+'.herokuapp.com'
